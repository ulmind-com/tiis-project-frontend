...
const Team = () => {
  ...
  return (
    <div className="team-page animate-fade-in" style={{ paddingBottom: '4rem', overflow: 'hidden' }}>
      ...
      {/* Team Grid Section */}
      <section style={{ position: 'relative', zIndex: 2, marginTop: '-3rem', padding: '0 5%' }}>
                  ...
                  <div style={{ padding: '2.5rem 2rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                      <div style={{ paddingRight: '1rem' }}>
                        <h3 style={{ color: 'var(--color-primary-dark)', fontSize: '1.4rem', fontWeight: '800', marginBottom: '0.4rem', letterSpacing: '-0.3px' }}>{member.name}</h3>
                    ...
                    {member.bio ? (
                      <p style={{ color: 'var(--color-text-muted)', fontSize: '1rem', lineHeight: '1.7', margin: 0, whiteSpace: 'pre-line', flex: 1 }}>
                        {member.bio}
                      </p>
                    ) : (
                      <p style={{ color: 'var(--color-text-muted)', fontSize: '1rem', fontStyle: 'italic', flex: 1 }}>No bio provided.</p>
                    )}
                  </div>
                </motion.div>
              ))}
