    ...
    <>
      <style>{`
        ...
        @media (max-width: 1024px) {
          ...
          .manage-news-table, .manage-news-table tbody, .manage-news-table tr, .manage-news-table td {
            display: block;
            width: 100%;
          }
          .manage-news-table thead {
            display: none; /* Hide headers on mobile */
          }
          .manage-news-table tr {
          ...
          .manage-news-table td:nth-last-child(2) {
            border-bottom: none !important; /* Remove line above actions */
          }
          .manage-news-table td:last-child {
            margin-top: 0.5rem;
          ...
          .manage-news-table td:last-child::before {
            display: none; /* No label for the action buttons */
          }
          
          /* Smart truncation for mobile headline */
          .news-headline-text {
      ...
      <div className="manage-news-container" style={{ display: 'grid', gridTemplateColumns: '1.6fr 1fr', gap: '1.5rem', paddingBottom: '2rem' }}>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} style={{
          ...
          {loading ? (
            ...
            <table className="manage-news-table" style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.88rem' }}>
              <thead>
                ...
                <AnimatePresence>
                  {items.map(item => (
                    <motion.tr key={item._id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                      ...
                      <td data-label="Headline" className="news-headline-text" style={{ padding: '0.75rem 1rem', fontWeight: 600, color: 'var(--color-text-main)', maxWidth: '220px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                        {item.title}
                      </td>
                      ...
                      <td data-label="Actions" style={{ padding: '0.75rem 1rem' }}>
                        <div style={{ display: 'flex', gap: '0.5rem', width: '100%', justifyContent: 'flex-end' }}>
                          <button className="news-action-btn" onClick={() => handleEdit(item)} title="Edit"
                          ...
                          <button className="news-action-btn" onClick={() => handleDelete(item._id)} title="Delete"
