    ...
    <>
      <style>{`
        ...
        @media (max-width: 1024px) {
          .manage-testimonials-container {
            grid-template-columns: 1fr !important;
            gap: 2rem !important;
          }
          
          /* Magic Table to Card Conversion for Mobile */
          .manage-testimonials-table, .manage-testimonials-table tbody, .manage-testimonials-table tr, .manage-testimonials-table td {
            display: block;
            width: 100%;
          }
          .manage-testimonials-table thead {
            display: none; /* Hide headers on mobile */
          }
          .manage-testimonials-table tr {
          ...
          .manage-testimonials-table td::before {
          ...
          .manage-testimonials-table td:nth-last-child(2) {
            border-bottom: none !important; /* Remove line above actions */
          }
          .manage-testimonials-table td:last-child {
            margin-top: 0.5rem;
          ...
          .manage-testimonials-table td:last-child::before {
          ...
          /* Rating stars adjustment for mobile */
          .mobile-stars-wrap {
      ...
      <div className="manage-testimonials-container" style={{ display: 'grid', gridTemplateColumns: '1.6fr 1fr', gap: '1.5rem', paddingBottom: '2rem' }}>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} style={{
          ...
          {loading ? (
            ...
            <table className="manage-testimonials-table" style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.88rem' }}>
              <thead>
                ...
                <AnimatePresence>
                  {items.map(item => (
                    <motion.tr key={item._id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                      ...
                      <td data-label="Client" style={{ padding: '0.75rem 1rem', display: 'flex', alignItems: 'center', gap: '0.8rem' }}>
                        {item.imageUrl ?
                      ...
                      <td data-label="Rating" style={{ padding: '0.75rem 1rem' }}>
                        <div className="mobile-stars-wrap" style={{ display: 'flex', alignItems: 'center', color: '#fbbf24', gap: '0.1rem', justifyContent: 'flex-end' }}>
                          {[...Array(5)].map((_, i) => (
                      ...
                      <td data-label="Actions" style={{ padding: '0.75rem 1rem' }}>
                        <div style={{ display: 'flex', gap: '0.5rem', width: '100%', justifyContent: 'flex-end' }}>
                          <button className="testimonial-action-btn" onClick={() => handleEdit(item)} title="Edit"
                          ...
                          <button className="testimonial-action-btn" onClick={() => handleDelete(item._id)} title="Delete"
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                {[1, 2, 3, 4, 5].map(star => (
                  <Star
                    key={star}
                    size={28} /* Increased star size slightly for better touch target */
