...
const ViewApplications = () => {
  ...
  return (
    <div>
      ...
      {/* Filters */}
      <div style={{ backgroundColor: 'var(--color-card-bg)', padding: '1.25rem 1.5rem', borderRadius: '8px', boxShadow: 'var(--shadow-sm)', marginBottom: '1.5rem', display: 'flex', gap: '1rem', alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        <select
          ...
          style={{ padding: '0.4rem 0.75rem', border: '1px solid var(--border-color)', borderRadius: '6px', fontSize: '0.9rem', backgroundColor: 'var(--color-card-bg)' }}
        >
